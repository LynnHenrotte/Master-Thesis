...
#SBATCH --job-name=simulate-ReSeq-CYP2C9_30x_%a  # Name of job
#SBATCH --output=stdout-simulate-ReSeq-CYP2C9_30x_%a   # Standard output name
#SBATCH --error=stderror-simulate-ReSeq-CYP2C9_30x_%a    # Standard Errorname
...
OUT=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_30x/
...
then
    ...
    reseq illuminaPE -R $REF -s $STAT_FILE -p $PROB_FILE --coverage 30 --ipfIterations 0 \
...
OUT_COVERAGE=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_30x_coverage/
COVERAGE_SUMMARY=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_30x_coverage_summary.tsv
