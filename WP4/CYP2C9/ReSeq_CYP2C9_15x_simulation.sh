...
#SBATCH --job-name=simulate-ReSeq-CYP2C9_15x_%a  # Name of job
#SBATCH --output=stdout-simulate-ReSeq-CYP2C9_15x_%a   # Standard output name
#SBATCH --error=stderror-simulate-ReSeq-CYP2C9_15x_%a    # Standard Errorname
...
OUT=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_15x/
...
OUT_COVERAGE=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_15x_coverage/
COVERAGE_SUMMARY=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_15x_coverage_summary.tsv
