...
#SBATCH --job-name=ReSeq-CYP2C9-30x-evaluation # Name of job
#SBATCH --output=stdout-ReSeq-CYP2C9-30x-evaluation   # Standard output name
#SBATCH --error=stderror-ReSeq-CYP2C9-30x-evaluation    # Standard Errorname
...
OUT=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_30x_evaluation/
IN=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_30x/
