...
#SBATCH --job-name=ReSeq-CYP2C9-5x-evaluation # Name of job
#SBATCH --output=stdout-ReSeq-CYP2C9-5x-evaluation   # Standard output name
#SBATCH --error=stderror-ReSeq-CYP2C9-5x-evaluation    # Standard Errorname
...
OUT=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_5x_evaluation/
IN=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_5x/
...
for ((ALLELE = 1; ALLELE <= 85; ALLELE++)); do
    ...
    bbmap.sh ref=$REF in=${IN}ReSeq_CYP2C9_${ALLELE}_left.fq in2=${IN}ReSeq_CYP2C9_${ALLELE}_right.fq \
        out=temp3.sam statsfile=${OUT}CYP2C9_${ALLELE}_map_stats.txt \
