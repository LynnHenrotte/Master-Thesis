...
#SBATCH --job-name=ReSeq-check-errors-CYP2C9-30x_%a # Name of job
#SBATCH --output=stdout-ReSeq-check-errors-CYP2C9-30x_%a   # Standard output name
#SBATCH --error=stderror-ReSeq-check-errors-CYP2C9-30x_%a    # Standard Errorname
...
STATS=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_30x_sim_stats.tsv
if [ $ALLELE == 2 ]
then
