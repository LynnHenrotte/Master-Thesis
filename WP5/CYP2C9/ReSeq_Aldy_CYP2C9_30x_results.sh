...
#SBATCH --job-name=ReSeq-Aldy-CYP2C9-30x-results # Name of job
#SBATCH --output=stdout-ReSeq-Aldy-CYP2C9-30x-results   # Standard output name
#SBATCH --error=stderror-ReSeq-Aldy-CYP2C9-30x-results    # Standard Errorname
...
RESULTS=${STAGING}Diplotype_Callers/Aldy/Aldy_ReSeq_CYP2C9_diplotype_calls_30x/
SUMMARY=${STAGING}Diplotype_Callers/Aldy/Aldy_Calls_CYP2C9_30x_summary.tsv
