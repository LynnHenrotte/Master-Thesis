...
#SBATCH --job-name=ReSeq-PyPGx-CYP2C9-60x-results # Name of job
#SBATCH --output=stdout-ReSeq-PyPGx-CYP2C9-60x-results   # Standard output name
#SBATCH --error=stderror-ReSeq-PyPGx-CYP2C9-60x-results    # Standard Errorname
...
RESULTS=${STAGING}Diplotype_Callers/PyPGx/ReSeq_PyPGx_CYP2C9_60x_calls/
SUMMARY=${OUT}ReSeq_PyPGx_CYP2C9_60x_results.tsv
