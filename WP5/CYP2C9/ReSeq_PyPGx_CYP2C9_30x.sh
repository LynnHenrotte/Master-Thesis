...
#SBATCH --job-name=ReSeq-PyPGx-CYP2C9-30x_%a # Name of job
#SBATCH --output=stdout-ReSeq-PyPGx-CYP2C9-30x_%a   # Standard output name
#SBATCH --error=stderror-ReSeq-PyPGx-CYP2C9-30x_%a    # Standard Errorname
...
RESULTS=${OUT}ReSeq_PyPGx_CYP2C9_30x_calls/
BAMFILES1=${STAGING}ReSeq_diplotypes_30x_part1/
BAMFILES2=${STAGING}ReSeq_diplotypes_30x_part2/
BAMFILES3=${STAGING}ReSeq_diplotypes_30x_part3/
...
do
    ...
    mv -f PyPGx-CYP2C9-diplo-${ALLELE1}-${ALLELE2}.vcf.gz* ${STAGING}ReSeq_PyPGx_CYP2C9_30x_diplotype_VCFs/
