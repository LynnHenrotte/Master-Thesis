...
#SBATCH --job-name=ReSeq-Aldy-CYP2C9-10x-%a # Name of job
#SBATCH --output=stdout-ReSeq-Aldy-CYP2C9-10x-%a   # Standard output name
#SBATCH --error=stderror-ReSeq-Aldy-CYP2C9-10x-%a    # Standard Errorname
#SBATCH --ntasks=1            # Number of tasks
#SBATCH --cpus-per-task=8     # Number of CPU cores
#SBATCH --time=0-15:00:00       # Wall time (format: d-hh:mm:ss)
...
BAM_FILES=${STAGING}ReSeq_diplotypes_10x_part${SLURM_ARRAY_TASK_ID}/
OUT=${STAGING}Diplotype_Callers/Aldy/Aldy_ReSeq_CYP2C9_diplotype_calls_10x/
