...
#SBATCH --job-name=ReSeq-Aldy-CYP2C9-60x-results # Name of job
#SBATCH --output=stdout-ReSeq-Aldy-CYP2C9-60x-results   # Standard output name
#SBATCH --error=stderror-ReSeq-Aldy-CYP2C9-60x-results    # Standard Errorname
...
RESULTS=${STAGING}Diplotype_Callers/Aldy/Aldy_ReSeq_CYP2C9_diplotype_calls_60x/
SUMMARY=${STAGING}Diplotype_Callers/Aldy/Aldy_Calls_CYP2C9_60x_summary.tsv
