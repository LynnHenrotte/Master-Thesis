...
#SBATCH --output=stdout-ReSeq-PyPGx-CYP2C9-30x-results   # Standard output name
#SBATCH --error=stderror-ReSeq-PyPGx-CYP2C9-30x-results    # Standard Errorname
...
RESULTS=${STAGING}Diplotype_Callers/PyPGx/ReSeq_PyPGx_CYP2C9_30x_calls/
SUMMARY=${OUT}ReSeq_PyPGx_CYP2C9_30x_results.tsv
