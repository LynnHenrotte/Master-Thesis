...
#SBATCH --job-name=ReSeq-StellarPGx-CYP2C9-60x-results # Name of job
#SBATCH --output=stdout-ReSeq-StellarPGx-CYP2C9-60x-results   # Standard output name
#SBATCH --error=stderror-ReSeq-StellarPGx-CYP2C9-60x-results    # Standard Errorname
...
RESULTS=${STAGING}Diplotype_Callers/StellarPGx/ReSeq_CYP2C9_diplotype_calls_60x/cyp2c9/alleles/
SUMMARY=${STAGING}Diplotype_Callers/StellarPGx/ReSeq_StellarPGx_CYP2C9_60x_summary.tsv
...
do
    ...
    if [ ${RESULTS}CYP2C9_diplo_${allele1}_${allele2}_new_cyp2c9.alleles ]
    then 
