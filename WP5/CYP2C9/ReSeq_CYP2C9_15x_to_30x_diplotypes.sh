...
#SBATCH --output=stdout-ReSeq-diplotypes-CYP2C9-15x-to-30x_%a   # Standard output name
#SBATCH --error=stderror-ReSeq-diplotypes-CYP2C9-15x-to-30x_%a    # Standard Errorname
...
OUT=${STAGING}ReSeq_diplotypes_30x/
...
do
    ...
    then
        BAM1=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_15x/ReSeq_CYP2C9_${ALLELE1}_aligned.bam
        BAM2=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_15x/ReSeq_CYP2C9_${ALLELE1}_aligned2.bam
    else      
        BAM1=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_15x/ReSeq_CYP2C9_${ALLELE1}_aligned.bam
        BAM2=${DATA}Simulations_CYP2C9/ReSeq/ReSeq_CYP2C9_15x/ReSeq_CYP2C9_${ALLELE2}_aligned.bam
    fi
