...
#SBATCH --job-name=ReSeq-StellarPGx-CYP2C19 # Name of job
#SBATCH --output=stdout-ReSeq-StellarPGx-CYP2C19   # Standard output name
#SBATCH --error=stderror-ReSeq-StellarPGx-CYP2C19    # Standard Errorname
...
nextflow run ${MAIN} -profile standard --build hg38 --gene cyp2c19
